...
4.	Read three integer inputs — n, v1, and v2.
5.	Calculate elevatorTime = (2 × n) / v2 and stairsTime = (√2 × n) / v1.
6.	Compare both times and print "Stairs" if stairs are faster, else "Elevator".
7.	End the program.
