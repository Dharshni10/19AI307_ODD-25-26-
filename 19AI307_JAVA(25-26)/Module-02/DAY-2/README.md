...
4. In the main class, read an integer input from the user.
5. Create an object of the demo class.
6. Call the cube() method using the object and print the result.
7. End the program.
...
<img width="330" height="147" alt="image" src="https://github.com/user-attachments/assets/e35f9538-c4a5-4f60-a15c-e4cce86eb216" />

## RESULT:
Thus, the program successfully computes the cube of a number by internally using the square method.
